...
export default function SlideAssistantVsAgent({ slideIndex }: SlideProps) {
  return (
    <>
      ...
      <div className="assistant-agent-layout reveal">
        <div className="assistant-agent-visual">
          <img src={`${BASE}futurama-head.jpg`} alt="Образ ассистента и агента" />
        </div>

        <div className="assistant-agent-cards">
